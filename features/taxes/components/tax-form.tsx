  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>{tax ? "Editar Guia de Imposto" : "Nova Guia de Imposto"}</DialogTitle>
          <DialogDescription>
            Cadastre uma guia de imposto a recolher (DARF, GPS, GARE, DAS, GNRE, etc.).
          </DialogDescription>
        </DialogHeader>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="grid gap-6 py-4">
            ...
            <div className="space-y-4">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Nome da Guia *</FormLabel>
                    <FormControl>
                      <Input autoFocus placeholder="Ex: DAS, DARF IRPJ, GPS, GARE-ISS" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea placeholder="Descreva a guia..." rows={2} {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <div className="space-y-3 border rounded-lg p-4 bg-muted/20">
              ...
              <p className="text-xs text-muted-foreground">
                Selecione os regimes para os quais esta guia se aplica. Deixe todos desmarcados para aplicar a todos.
              </p>
            ...
            {/* 5. Gestão (prioridade, responsável, protocolo, status só na edição) */}
            <div className="space-y-4 border-t pt-4">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Protocolo / Comprovante</FormLabel>
                    <FormControl>
                      <Input placeholder="Número do protocolo de pagamento" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
