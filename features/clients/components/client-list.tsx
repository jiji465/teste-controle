...
export function ClientList({ clients, onUpdate }: ClientListProps) {
  ...
  const handleApplyTemplate = async (templatesSelected: TemplateItem[]) => {
    ...
    const result = await applyTemplateToClient(templateClient, templatesSelected)
  ...
  return (
    <div className="space-y-4">
      ...
      <BulkActionsBar
        ...
        actions={[
          { label: "Ativar", icon: <CheckCircle2 className="size-3.5" />, tone: "success", onClick: () => handleBulkSetStatus("active"), disabled: bulkLoading },
