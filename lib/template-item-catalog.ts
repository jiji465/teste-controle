...
export const TEMPLATE_ITEM_CATALOG: CatalogItem[] = [
  ...
  { group: "Lucro Presumido / Real", name: "IRPJ Trimestral", description: "Imposto de Renda PJ - apuração trimestral", category: "tax_guide", scope: "federal", dueDay: 30, frequency: "quarterly", recurrence: "quarterly", weekendRule: "anticipate", priority: "urgent" },
  { group: "Lucro Presumido / Real", name: "CSLL Trimestral", description: "Contribuição Social - apuração trimestral", category: "tax_guide", scope: "federal", dueDay: 30, frequency: "quarterly", recurrence: "quarterly", weekendRule: "anticipate", priority: "high" },
  { group: "Lucro Presumido / Real", name: "IRPJ Mensal", description: "IRPJ - apuração mensal antecipada", category: "tax_guide", scope: "federal", dueDay: 30, frequency: "monthly", recurrence: "monthly", weekendRule: "anticipate", priority: "urgent" },
  { group: "Lucro Presumido / Real", name: "CSLL Mensal", description: "CSLL - apuração mensal antecipada", category: "tax_guide", scope: "federal", dueDay: 30, frequency: "monthly", recurrence: "monthly", weekendRule: "anticipate", priority: "high" },
