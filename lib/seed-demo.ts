...
function buildTaxes(): Tax[] {
  ...
  return [
    { id: crypto.randomUUID(), name: "DAS",     scope: "federal",   description: "Documento de Arrecadação do Simples Nacional", dueDay: 20, status: "pending", priority: "urgent", recurrence: "monthly",   weekendRule: "postpone", autoGenerate: true,  applicableRegimes: ["simples_nacional"], createdAt: now },
    { id: crypto.randomUUID(), name: "DAS-MEI", scope: "federal",   description: "Documento de Arrecadação do MEI",              dueDay: 20, status: "pending", priority: "urgent", recurrence: "monthly",   weekendRule: "postpone", autoGenerate: true,  applicableRegimes: ["mei"],              createdAt: now },
    { id: crypto.randomUUID(), name: "ISS",     scope: "municipal", description: "Imposto Sobre Serviços",                           dueDay: 10, status: "pending", priority: "high",   recurrence: "monthly",   weekendRule: "postpone", autoGenerate: true,  applicableRegimes: ["simples_nacional", "lucro_presumido", "lucro_real"], createdAt: now },
    { id: crypto.randomUUID(), name: "ICMS",    scope: "estadual",  description: "Imposto sobre Circulação de Mercadorias",          dueDay: 9,  status: "pending", priority: "high",   recurrence: "monthly",   weekendRule: "postpone", autoGenerate: true,  applicableRegimes: ["lucro_presumido", "lucro_real"],                     createdAt: now },
    { id: crypto.randomUUID(), name: "IRPJ",    scope: "federal",   description: "Imposto de Renda Pessoa Jurídica",             dueDay: 30, status: "pending", priority: "urgent", recurrence: "quarterly", weekendRule: "anticipate", autoGenerate: true, applicableRegimes: ["lucro_presumido", "lucro_real"],                     createdAt: now },
    { id: crypto.randomUUID(), name: "CSLL",    scope: "federal",   description: "Contribuição Social sobre Lucro Líquido",      dueDay: 30, status: "pending", priority: "high",   recurrence: "quarterly", weekendRule: "anticipate", autoGenerate: true, applicableRegimes: ["lucro_presumido", "lucro_real"],                     createdAt: now },
    { id: crypto.randomUUID(), name: "PIS",     scope: "federal",   description: "Programa de Integração Social",                dueDay: 25, status: "pending", priority: "high",   recurrence: "monthly",   weekendRule: "postpone", autoGenerate: true,  applicableRegimes: ["lucro_presumido", "lucro_real"],                     createdAt: now },
    { id: crypto.randomUUID(), name: "COFINS",  scope: "federal",   description: "Contribuição p/ Financiamento da Seguridade",  dueDay: 25, status: "pending", priority: "high",   recurrence: "monthly",   weekendRule: "postpone", autoGenerate: true,  applicableRegimes: ["lucro_presumido", "lucro_real"],                     createdAt: now },
    { id: crypto.randomUUID(), name: "INSS",    scope: "federal",   description: "Guia da Previdência Social",                   dueDay: 20, status: "pending", priority: "high",   recurrence: "monthly",   weekendRule: "postpone", autoGenerate: true,  applicableRegimes: [],                                                    createdAt: now },
    { id: crypto.randomUUID(), name: "FGTS",    scope: "federal",   description: "Fundo de Garantia do Tempo de Serviço",            dueDay: 7,  status: "pending", priority: "high",   recurrence: "monthly",   weekendRule: "postpone", autoGenerate: true,  applicableRegimes: [],                                                    createdAt: now },
    { id: crypto.randomUUID(), name: "IPI",     scope: "federal",   description: "Imposto sobre Produtos Industrializados",      dueDay: 25, status: "pending", priority: "high",   recurrence: "monthly",   weekendRule: "postpone", autoGenerate: true,  applicableRegimes: ["lucro_presumido", "lucro_real"],                     createdAt: now },
    { id: crypto.randomUUID(), name: "IRRF",    scope: "federal",   description: "Imposto de Renda Retido na Fonte",             dueDay: 20, status: "pending", priority: "medium", recurrence: "monthly",   weekendRule: "postpone", autoGenerate: true,  applicableRegimes: [],                                                    createdAt: now },
  ]
}
